...
extern bool hyundai_blatv2_high_limits;
bool hyundai_blatv2_high_limits = false;
...
void hyundai_common_init(uint16_t param) {
  ...
  const uint16_t HYUNDAI_PARAM_BLATV2_HIGH_LIMITS = 1024;
  ...
  hyundai_blatv2_high_limits = GET_FLAG(param, HYUNDAI_PARAM_BLATV2_HIGH_LIMITS);
